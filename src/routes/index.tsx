    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row items-center gap-2 lg:gap-5">
          ...
          <Button variant="ghost" className="relative p-0">
            <div className="size-6 lg:size-9 bg-purple rounded-full"></div>
            <div className="size-2 bg-green rounded-full absolute bottom-0 -right-0.5 border-2 border-white"></div>
          </Button>
        </div>
      </div>
